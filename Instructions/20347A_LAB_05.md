...
3. Edit user **Huong Tang** and assign an Office 365 Enterprise E3 license using the location of the United Kingdom.
...
6. Sign out, and then sign in as Abbi Skinner with the username  **Abbi@Adatum _yyxxxxx_. _hostdomain_.com** and the password **Pa55w.rd**.

7. Access Abbi's Office 365 settings and verify that she does not have the option to install the Office 365 apps. 

8. Sign out as Abbi Skinner, and then sign in as  **Beth** with the username **beth@Adatum _yyxxxxx_. _hostdomain_.com** with the password of **Pa55w.rd**.
...
13. Open a new browser, and then sign in to the Office 365 environment with the administrator Holly's credentials and password.
