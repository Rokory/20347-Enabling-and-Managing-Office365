...
1. In User profiles, select the user profile of  **Christie**, and add  **Holly** as her manager.
...
2. Edit the properties of the site, and add  **Christie Thomas** as an additional site collection administrator.

3. Sign in as **Christie@adatumyyxxxxx.hostdomain.com** and verify if you are a site collection administrator of the site.
...
2. Sign in as  **Catherine@Adatumyyxxxxx.hostdomain.com**, with the password of  **Pa55w.rd**. 
...
6. On the  **Site Permissions** page, approve Catherine Richard's access request, and then add Tameka Reed to the site members group.

7. Access the site again as Catherine and verify that she has access. 

8. Access the site as Tameka and verify that she has access. 
