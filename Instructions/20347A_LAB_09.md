...
6. On the  **Site Permissions** page, approve Beth Burke's access request, and then add Francisco Chaves to the site members group.

7. Access the site again as Beth and verify that she has access. 

8. Access the site as Francisco and verify that he has access. 
