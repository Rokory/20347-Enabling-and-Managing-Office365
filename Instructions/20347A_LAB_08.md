...
Virtual machines:  **20347A-LON-DC1**,  **20347A-LON-DS1**,  **20347A-LON-CL1**,  **20347A-LON-CL2,** **and** **20347A-LON-CL3**
...
- LON-CL2
  ...
  - Sign in as  **Francisco** by using the password **Pa55w.rd**
...
3. Create a new Skype meeting request, and then send it to Christie.
...
1. On LON-CL1, in the Office 365 admin center, edit the Sallie McIntosh user account to remove the option to use Skype for Business. 

2. In the Skype for Business admin center, verify that Sallie McIntosh is not listed as a Skype for Business user.

3. Edit Lindsey's Skype for Business user settings to remove the option to record meetings, and to prevent her from communicating with public Skype users.

4. Edit Amy's Skype for Business user settings to enable her to connect to audio meetings only.



#### Task 2: Verify Skype for Business communications
  
1. On LON-CL3, ensure that you are signed in as Christie. Open Outlook 2016 and configure a profile for Christie@adatumyyxxxxx.hostdomain.com.

2. Open Skype for Business and sign in as  **Christie@adatamyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.

3. On LON-CL1, create a Skype meeting request for a meeting that will start within the next 15 minutes, and then send the request to Francisco Chaves and Christie Thomas.

4. In Skype for Business, send Christie an IM.

5. On LON-CL3, respond to the message. 

6. Accept the meeting request from Holly, and then join the meeting.

7. On LON-CL1, join the meeting, and then verify that Christie is connected to the meeting.

8. On LON-CL1, share your desktop. 

9. On LON-CL3, verify that Holly's desktop is visible in the meeting window. 
...
1. On LON-CL2, ensure that you are signed in as Francisco. Open Outlook 2016 and configure a profile for Francisco@adatumyyxxxxx.hostdomain.com.

2. Open Skype for Business and sign in as  **Francisco@adatamyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.

3. In Outlook 2016, accept the broadcast meeting request from Holly. 

4. Join the broadcast meeting. Verify that Francisco can join the meeting.

5. Start the broadcast as a content only meeting.

6. On LON-CL3, accept the broadcast meeting request from Holly.

7. Join the meeting as Christie.

8. Verify that Christie can join the meeting.

9. On LON-CL2, stop the broadcast.

10. On both LON-CL1 and LON-CL3, disconnect from the meeting.
