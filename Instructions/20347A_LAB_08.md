...
3. Edit Beth Burke's Skype for Business user settings to remove the option to record meetings, and to prevent her from communicating with public Skype users.
...
1. On LON-CL2, ensure that you are signed in as Francisco. Open Outlook 2016 and configure a profile for Francisco@adatumyyxxxxx.hostdomain.com, if necessary.

2. Open Skype for Business and sign in as  **Francisco@adatamyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.

3. On LON-CL1, create a Skype meeting request for a meeting that will start within the next 15 minutes, and then send the request to Francisco Chaves and Beth Burke.

4. In Skype for Business, send Francisco an IM.

5. On LON-CL2, respond to the message. 

6. Accept the meeting request from Holly, and then join the meeting.

7. On LON-CL1, join the meeting, and then verify that Francisco is connected to the meeting.

8. On LON-CL1, share your desktop. 

9. On LON-CL2, verify that Holly's desktop is visible in the meeting window. 

10. On LON-CL2, disconnect from the meeting.
...
1. Sign in to LON-CL1 as Beth. Open Outlook 2016 and configure a profile for Beth@adatumyyxxxxx.hostdomain.com.
...
6. On LON-CL2, accept the broadcast meeting request from Holly.

7. Join the meeting as Francisco.

8. Verify that Francisco can join the meeting.

9. On LON-CL1, stop the broadcast.

10. On LON-CL2, disconnect from the meeting.

11. Sign out from LON-CL1. 
