...
1. On **LON-CL3**. Verify that you are signed in as Holly.

2. Open  **Microsoft Edge**.

3. In the  **address bar**, type  **https://portal.office.com**, and then press Enter.

4. On the  **Sign in** page, in the **Name** box, type **Holly@AdatumYYXXXXX.hostdomain.com**.

5. In the  **Password** box, type **Pa55w.rd**, and then click  **Signin**. 

6. On the  **Office 365** home page page, click the small Gear icon in the top-right corner, and then click **Office 365**.

7. On the  **Settings** page, click **Software**.

  >  **Note:** This user has a license, and Office 2016 is now available for download.

8. Verify that  **Office** and **Skype for Business** desktop software are available to install.

9. Do not install, but notice that this user can now install the 32-bit version of Office 365 ProPlus and select which language they want to install. They must click  **Advanced** to turn on the 64-bit version option.

10. Note also that  **Phone and tablet** apps are available from the left menu.

11. In the Language section, select the language to install from the drop-down menu.

12. Leave  **32-bit (recommended)** selected.

13. Click  **Install**.

14. In the  **Microsoft Edge** notification bar, click **Save**, and then click  **Run**.

15. If the  **User Account Control** dialog box appears, type **Adatum\\Holly** in the user name box, in the **Password** box, type **Pa55w.rd**, and then click  **Yes**.

16. On the taskbar, click the  **Office** icon, and note the status of the download.

  >  **Note:** It will take several minutes to complete, but applications are now available.

17. Click  **Close** when the wizard finishes.

18. Go to the  **Start** screen.

19. On the  **Start** screen, click **Word 2016**. On the first things first window click  **Accept**.

20. In the top-right corner, if no one is signed in, sign in as  **holly@adatumYYXXXXX.hostdomain.com**, with the password  **Pa55w.rd**, by clicking the link  **Sign in to get most out of office**.

21. Once signed in, your subscription license is activated. At the top right, under  **Beth Burke**, click  **Switch account**.

22. Type some text.

23. Click  **File**, then click  **Save**.

24. Click  **Sites - A. Datum** and click **A. Datum** in the right pane.

25. Double-click the  **Documents** folder and then save the file with the name **Meeting Agenda**. 

26. Click  **Save**. You might see a  **streaming features** message.

27. Close  **Word**. 

25. Switch back to  **Holly Spencer**'s Office 365 session in Microsoft Edge.
...
1. In the  **Office 365 admin center**, click  **Users**, and then click  **Beth Burke**.

2. In the right pane, under  **Product licenses**, click  **Edit**. 

3. Under  **Office 365 Enterprise E5**, set the  **Office 365 ProPlus** option to **Off** to remove the license from Beth's account, click **Save**, and then click  **Close** twice.

4. In the top-right corner, click the  **Settings** icon, and then click **Office 365**.

5. On the  **Settings** page, click **Software**.

6. Note that the Office installation is no longer listed, as this user no longer has an active license (although software is available).
...
3. Under  **Office 365 Enterprise E5**, set the  **Office 365 ProPlus** option to **On**, click  **Save**, and then click  **Close** twice.
...
1. Switch to  **LON-CL4**, and if necessary, and sign in as  **Adatum\\Holly**, with the password,  **Pa55w.rd**. 
...
8. Sign in as  **ADATUM\\Holly** with the password **Pa55w.rd**. You may have to wait for Office to finish installing.
...
11. On the  **Activate Office** page, in the **E-mail address** box, type **Holly@AdatumYYXXXXX.hostdomain.com**, and then click  **Next**.
