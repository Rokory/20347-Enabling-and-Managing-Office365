...
3. Open Outlook 2016. Create a new message for Lindsey Gates. On the  **Options** tab, click **Permission**, and then connect to the Rights Management server to get templates.

4. Click  **Permission** again, apply the **Do not Forward** policy, and then send the message.

5. In Microsoft Edge, connect to https://adatumyyxxxxx.sharepoint.com/. 
...
7. Enable Information Rights Management (IRM), and then configure a policy with the following settings:
  ...
  - Title:  **Adatum Policy**.
  - Description:  **Adatum policy for downloads**
  -  **Allow viewers to write on a copy of the downloaded document**. 

8. Close Microsoft Edge.

9. Open Microsoft Edge, and then connect to https://portal.office.com. Sign in as  **Lindsey@adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**. 

10. Check Lindsey's email, and then verify that you received an email from Holly that is IRM protected. Click the message. 

11. Verify that you do not have the option to forward or print the message. 

12. In Microsoft Edge, connect to https://adatumyyxxxxx.sharepoint.com/. 
...
3. In the Security &amp; Compliance Center, configure Lindsey Gates as a Compliance Administrator and add her to the Compliance Management and Recipient Management groups in Exchange Online. Add Christie Thomas as an eDiscovery Manager. 
...
1. On LON-CL1, open Microsoft Edge, and then connect to https://protection.office.com as  **Lindsey@Adatumyyxxxxx.hostdomain.com**. Beth is a member of the Compliance Administrator role group, so he can connect to the protection website.

2. In the navigation pane, click  **Data governance**, and then click  **Archive**.

3. Configure Christie Thomas and Amy Santiago with archive mailboxes. 
...
1. Open Microsoft Edge, and then connect to https://portal.office.com as Lindsey@Adatumyyxxxxx.hostdomain.com.
...
1. Connect to your Microsoft account mailbox, and then verify that you received the message from Lindsey.
...
4. Access Lindsey's mailbox and verify that she received a notification about the message that was sent to your Microsoft account. 
