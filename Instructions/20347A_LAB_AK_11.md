...
8. Create a new email with  **Lindsey Gates** as the recipient.
...
13. In Microsoft Edge, connect to https://adatumyyxxxxx.sharepoint.com/. 
...
17. In the  **Create a permission policy title** box, type **Adatum Policy**.

18. In the  **Add a permission policy description** box, type **Adatum policy for downloads.**
...
23. Open Microsoft Edge, and then connect to  **https://portal.office.com**. Sign in as  **Lindsey@adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**. 
...
28. In Microsoft Edge, connect to https://adatumyyxxxxx.sharepoint.com/. 
...
8. In the Select Members window, click  **Lindsey Gates**, click  **add**, and then click  **OK**.
...
2. Sign in to the Office 365 portal as  **Lindsey@Adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**. Beth is a member of the Compliance Administrator role, so she can connect to the protection website.

3. In the navigation pane, click  **Data** **governance**, and then click  **Archive**.

4. In the Archive window, click  **Christie Thomas**, and then Ctrl + click  **Amy Santiago**.
...
12. Sign in to the Office 365 portal as  **Lindsey@Adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.
