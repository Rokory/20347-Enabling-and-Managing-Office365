...
4. In the result window, in the drop-down list, click  **Christie**.
...
16. In the text box at the top, type  **Francisco**, and then click  **Francisco Chaves**.
...
24. Sign in as  **Francisco@Adatumyyxxxxx.hostdomain.com**, with the password of  **Pa55w.rd**. 
