...
7. Select  **Beth Burke**, and then click  **Edit**.
...
1. On LON-CL2, ensure that you are signed in as Francisco. Open Outlook 2016. If you already configured Outlook 2016, skip to step 7.
...
9. Sign in as  **Francisco@adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.
...
12. In Outook 2016, create a Skype meeting request for a meeting that will start within the next 15 minutes, and then send the request to Francisco Chaves and Beth Burke.

13. In Skype for Business, in the  **Find someone** text box, type **Ada**.

14. Double-click  **Francisco Chaves** to open an IM window.

15. Type a message, and then press Enter.

16. On LON-CL2, verify that the IM from Holly is received and respond to it. 
...
20. Verify that Francisco is connected to the meeting.
...
26. On LON-CL2, verify that Holly's desktop is visible in the meeting window.

27. On LON-CL2, disconnect from the meeting.
...
1. Sign in to LON-CL1 as Beth. Open Outlook 2016. 
...
25. On LON-CL2, signed in as Francisco, in Outlook 2016, accept the meeting request from Holly. 

26. Open the meeting request, and then click  **Join the Meeting**.

27. On LON-CL1, in the broadcast window, click  **Stop Broadcast**, and then click  **Stop Broadcast** again.

28. On LON-CL2, disconnect from the meeting.

29. Sign out from LON-CL1.
