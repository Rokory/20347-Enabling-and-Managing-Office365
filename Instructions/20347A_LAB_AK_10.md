...
2. Sign in as  **Christie@adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.

3. On the Office 365 portal, click  **Yammer**.

4. At the  **WHO DO YOU WORK WITH** prompt, type **Amy** in the first text box, and then click **DONE** and close the window.
...
1. On  **LON-CL1**, click  **Start**, click  **All apps**, and then click  **Word 2016**. 

2. In the  **Word** window, in the top right corner, verify that Word is licensed to Christie Thomas.
...
6. On the  **Sign in** page, in the **E-mail address** box, type **Chrstie@AdatumYYXXXXX.hostdomain.com**, and then click  **Next**.

7. On the  **Sign in** page, in the **Password** box, type **Pa55w.rd**, and then click  **Sign in**.

8. Verify that Word is now licensed to Christie. Close Word.

9. Open Microsoft Edge, and then connect to  **https://portal.office.com**.

10. Sign in as  **Christie@adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.
...
14. In the  **Word Online** window, type some text, and then click **Christie Thomas** at the top of the window beside Word Online.
...
18. If prompted to sign in, type  **Christie@adatumyyxxxxx.hostdomain.com**, and then click  **Next**. 
...
15. In the menu bar right beside Word Online, click  **Christie Thomas** to return to OneDrive for Business.
...
9. Click the message with the subject  **Christie Thomas** **has shared Project Targets**. 
...
9. Click  **Add members**, and then click  **Catherine Richard**.
...
15. On  **LON-CL1**, open Microsoft Edge, and then sign in to  **https://portal.office.com** as **Catherine@Adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**. Select  **English (United States)** for language and select your time zone and click **Save**.
